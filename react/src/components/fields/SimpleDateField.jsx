...
import FormLabel from "react\node_modules@cmsgovdesign-system-coresrccomponentsFormLabelFormLabel.jsx";
import PropTypes from "node_modules@typesprop-types";
import React from "react";
// import TextField from '../TextField/TextField';
import TextField from "@cmsgov/design-system-core";
import classNames from "node_modules@typesclassnamesindex";
import uniqueId from "node_modules@typeslodash.uniqueid";

// Prevents day/month greater than 2 digits and year greater than 4 digits
const standardLengthFormatter = ({ month, year }) => ({
...
export class SimpleDateField extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  formatDate() {
    if (this.props.dateFormatter && this.monthInput && this.yearInput) {
      const values = {
