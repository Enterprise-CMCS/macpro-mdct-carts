...
OIDC_CLIENT_ID=op://mdct_devs/carts_secrets/OIDC_CLIENT_ID
OIDC_ISSUER=op://mdct_devs/carts_secrets/OIDC_ISSUER
OIDC_ISSUER_URL=op://mdct_devs/carts_secrets/OIDC_ISSUER_URL