              ...
              <div id="p1_q1">
                ...
                {this.state.p1_q1 === 'yes' ? (
                  <div className="conditional">
                    <legend className="ds-c-label">a) What are you doing differently?</legend>
                    <div className="textfield">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec consequat
                      orci. Aliquam posuere ligula urna, gravida suscipit neque sodales quis. Morbi
                      ultrices sapien placerat fringilla bibendum. Vestibulum maximus augue lorem,
                      quis molestie massa varius vitae. Aenean sit amet massa eu augue luctus
                      ornare.
                    </div>
                  </div>
                ) : null}
              ...
              <div id="p1_q3">
                <fieldset className="ds-c-fieldset ds-u-margin-top--0">
                  ...
                  <div className="textfield">
                    ...
                    orci. Aliquam posuere ligula urna, gravida suscipit neque sodales quis. Morbi
                    ultrices sapien placerat fringilla bibendum. Vestibulum maximus augue lorem,
                    quis molestie massa varius vitae. Aenean sit amet massa eu augue luctus ornare.
                  </div>
                </fieldset>
              </div>
            </div>
