...
class Questions3C extends Component {
  ...
  render() {
    return (
      <form>
        <div>
          <h3 className="part-header">Part 1: Eligibility Renewal and Retention</h3>
          <div className="question-container">
            <div className="question">
              1. Do you have authority in your CHIP state plan to provide for presumptive
              eligibility, and have you implemented this?
            </div>
            <div id="p1_q1">
              {
              ...
              <div className="conditional">
                <label className="ds-c-label">
                  What percentage of children are presumptively enrolled in CHIP pending a full
                ...
                <label className="ds-c-label">
                  Of those children who are presumptively enrolled, what percentage are determined
                  fully eligible and enrolled in the program?
                </label>
                <div className="textfield">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec consequat orci.
                  Aliquam posuere ligula urna, gravida suscipit neque sodales quis. Morbi ultrices
        ...
        <div className="question-container">
          <div className="question">
            2. Tell us how your state simplifies the eligibility renewal process for families in
            order to retain more children in CHIP.
          </div>
          <div className="sub-questions">
            ...
            <label className="ds-c-label">
              c. How many notices do you send to families before disenrolling a child from the
              program?
            </label>
            <div className="textfield">3</div>
            <label className="ds-c-label">
              d. How many notices do you send to families before disenrolling a child from the
              program?
            </label>
            <div className="textfield">6</div>

            <label className="ds-c-label">
              e. What else do you do to simplify the eligibility renewal process for families in
        ...
        <div className="question-container">
          <div className="question">
            3. Which retention strategies have been most effective in your state?
          </div>
          <div className="textfield">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec consequat orci.
        ...
        <div className="question-container">
          <div className="question">
            5. What data sources and methodology do you use for tracking effectiveness?
          </div>
          <div className="textfield">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam nec consequat orci.
            Aliquam posuere ligula urna, gravida suscipit neque sodales quis. Morbi ultrices sapien
        ...
        <div className="question-container">
          <div className="question">
            ...
            <div className="hint">
              Enter your data below and the percentages will be automatically calculated in the
              final report.
            </div>
          </div>
        ...
        <div className="question-container">
          <legend className="ds-c-label">
            2. How many applications were denied Title XXI coverage for procedural denials?
          </legend>
          <div className="textfield">18</div>
        </div>
        <div className="question-container">
          <legend className="ds-c-label">
            3. How many applicants were denied Title XXI coverage for eligibility denials?
          </legend>
          <div className="textfield">7</div>
        </div>
        <div className="question-container">
          <legend className="ds-c-label">
            4. How many applicants were denied Title XXI coverage and determined eligible for Title
            XIX instead?
          </legend>
          <div className="textfield unanswered-text"></div>
        </div>
        <div className="question-container">
          <legend className="ds-c-label">
            5. How many applicants were denied Title XXI coverage for other reasons?
          </legend>
        ...
        <div className="question-container">
          <legend className="ds-c-label">
            ...
            else you'd like to add about this section that wasn't already covered?
          </legend>
