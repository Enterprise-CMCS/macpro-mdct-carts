...
const fakeUserData = {
  AK: {
    ...
    imageURI: `${import.meta.env.PUBLIC_URL}/img/states/ak.svg`,
    formName: "CARTS FY",
    currentUser: {
  ...
  AZ: {
    ...
    // eslint-disable-next-line no-undef
    imageURI: `${import.meta.env.PUBLIC_URL}/img/states/az.svg`,
    formName: "CARTS FY",
    currentUser: {
      role: AppRoles.STATE_USER,
      state: {
  ...
  MA: {
    ...
    // eslint-disable-next-line no-undef
    imageURI: `${import.meta.env.PUBLIC_URL}/img/states/ma.svg`,
    formName: "CARTS FY",
    currentUser: {
      role: AppRoles.STATE_USER,
      state: {
