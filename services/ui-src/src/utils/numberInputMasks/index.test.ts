...
describe('Testing new regex defaults', () => {
  ...
  test('Testing integersWithMaxDecimalPlaces', () => {
    ...
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('234234234234')).toBeTruthy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('1234523452345')).toBeTruthy()

    expect(integersWithMaxDecimalPlaces(maxDecimals).test('-0')).toBeTruthy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('-34')).toBeTruthy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('-234234234234')).toBeTruthy()

    expect(integersWithMaxDecimalPlaces(maxDecimals).test('0.222')).toBeTruthy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('0.2354234')).toBeFalsy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('-0.212')).toBeTruthy()
    expect(integersWithMaxDecimalPlaces(maxDecimals).test('-0.2333333333')).toBeFalsy()
  })

  test('Testing positiveNumbersWithMaxDecimalPlaces', () => {
    const maxDecimals = 3
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('0')).toBeTruthy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('1999')).toBeTruthy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('234234234234')).toBeTruthy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('1234523452345')).toBeTruthy()

    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('-0')).toBeFalsy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('-34')).toBeFalsy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('-234234234234')).toBeFalsy()

    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('0.222')).toBeTruthy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('0.2354234')).toBeFalsy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('-0.212')).toBeFalsy()
    expect(positiveNumbersWithMaxDecimalPlaces(maxDecimals).test('-0.2333333333')).toBeFalsy()
  })
})
