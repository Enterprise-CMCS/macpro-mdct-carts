...
export const rateThatAllowsFourDecimals = /^((?:99|\d{1,2})(?:\.\d{0,4})?|(100\.?))$/i
export const rateThatAllowsOneDecimal = /^((?:99|\d{1,2})(?:\.\d{0,1})?|(100\.?))$/i
export const percentageAllowOneDecimalMax = /^((?:99|\d{1,2})(?:\.\d{0,1})?|(100))$/i
