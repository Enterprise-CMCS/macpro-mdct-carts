  ...
  2023: [
    {
      ...
      targets: [
        "$..*[?(@ && @.id=='2023-03-c-03-04-a')].answer.entry",
        "$..*[?(@ && @.id=='2023-03-c-03-04-b')].answer.entry",
        "$..*[?(@ && @.id=='2023-03-c-03-04-c')].answer.entry",
      ],
    },
    {
      hint: "The answer to 4 should be equal to the sum of a, b, and c below: ",
      targets: [
        "$..*[?(@ && @.id=='2023-03-c-04-04-a')].answer.entry",
        "$..*[?(@ && @.id=='2023-03-c-04-04-b')].answer.entry",
        "$..*[?(@ && @.id=='2023-03-c-04-04-c')].answer.entry",
      ],
    },
  ],
  2022: [
    {
      hint: "The answer to 4 should be equal to the sum of a, b, and c below: ",
      targets: [
        "$..*[?(@ && @.id=='2022-03-c-03-04-a')].answer.entry",
        "$..*[?(@ && @.id=='2022-03-c-03-04-b')].answer.entry",
        "$..*[?(@ && @.id=='2022-03-c-03-04-c')].answer.entry",
      ],
    },
    {
      hint: "The answer to 4 should be equal to the sum of a, b, and c below: ",
      targets: [
        "$..*[?(@ && @.id=='2022-03-c-04-04-a')].answer.entry",
        "$..*[?(@ && @.id=='2022-03-c-04-04-b')].answer.entry",
        "$..*[?(@ && @.id=='2022-03-c-04-04-c')].answer.entry",
      ],
    },
  ],
};
      ...
      fieldset_info: {
        rows: [
          [
            ...
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-03-01-c')].answer.entry"],
            },
          ],
          [
            { contents: "PMPM cost" },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-03-02-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-03-02-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-03-02-c')].answer.entry"],
            },
          ],
        ],
        headers: [
      ...
      fieldset_info: {
        rows: [
          [
            ...
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-01-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-01-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-01-c')].answer.entry"],
            },
          ],
          [
            { contents: "PMPM cost" },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-02-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-02-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2023-05-a-04-02-c')].answer.entry"],
            },
          ],
        ],
        headers: [
      ...
      fieldset_info: {
        rows: [
          [
            ...
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-01-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-01-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-01-c')].answer.entry"],
            },
          ],
          [
            { contents: "PMPM cost" },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-02-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-02-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-03-02-c')].answer.entry"],
            },
          ],
        ],
        headers: [
      ...
      fieldset_info: {
        rows: [
          [
            ...
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-01-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-01-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-01-c')].answer.entry"],
            },
          ],
          [
            { contents: "PMPM cost" },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-02-a')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-02-b')].answer.entry"],
            },
            {
              actions: ["identity"],
              targets: ["$..*[?(@ && @.id=='2022-05-a-04-02-c')].answer.entry"],
            },
          ],
        ],
        headers: [
