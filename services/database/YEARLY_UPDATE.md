...
3. In the seed-fmap file, you will add the data from the first tables right most column (The Enhanced federal medical assistance percentages). See prior heading for how to find this page.
