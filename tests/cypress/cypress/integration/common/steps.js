...
And(
  'verify "Both medicaid Expansion CHIP and Separate CHIP" is selected for Program type',
  () => {
...
And(
  'verify "Alabama Department of Public Health, CHIP PO Box 303017 Montgomery, AL 36130" is entered for Full mailling address',
  () => {
...
When(
  "user clicks on the Section 1: Program Fees and Policy Changes link",
  () => {
...
And(
  "verify Children with Chronic Conditions is selected for Part2 question 4",
  () => {
...
When(
  "user clicks on the Section 3I: Health Services Initiative (HSI) Programs",
  () => {
...
When(
  "user clicks on the Section 3D: Cost Sharing (Out-of-Pocket Costs)",
  () => {
...
When(
  "user clicks on the Section 3E: Employer Sponsored Insurance and Premium Assistance",
  () => {
...
Then(
  "user sees the Employer Sponsored Insurance and Premium Assistance title",
  () => {
