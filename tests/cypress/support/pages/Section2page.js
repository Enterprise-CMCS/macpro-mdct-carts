...
const num_uninsured_child_table = ".main .question:nth-child(2) [class='ds-c-table ds-u-margin-top--2']";
const percent_change = "synthesized-table-1";    //need to check
const reason_num_uninsured_child_changed = ".main .question:nth-child(4) [rows]";
...
const section2_Enrollment = "//a[@class='ds-c-vertical-nav__label ds-c-vertical-nav__label--current']";
