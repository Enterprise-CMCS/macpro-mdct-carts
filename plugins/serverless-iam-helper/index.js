...
function addProperties() {
  ...
  if (iamPermissionBoundary) {
    setPropertyForTypes.call(this, ['AWS::IAM::Role'], 'PermissionsBoundary', iamPermissionBoundary)
  }
}
...
function iamPermissionsBoundarySpecified() {
  return _.get(this.serverless, 'service.provider.iam.role.permissionsBoundary')
}
